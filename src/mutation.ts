...
export const createMutation = (axios: AxiosInstance) => async (q: GraphQLQuery): Promise<any> => {
    const convertedQ = q;
    ...
    let resp = null;
    const query: any = { mutation: convertedQ };
...
export default async (q: GraphQLQuery): Promise<any> => createMutation(getApiClient().axios)(q);
